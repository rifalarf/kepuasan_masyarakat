<div
    ...
    <form action="{{ route('result.store') }}" method="POST">
        ...
        <input type="hidden" name="email" value="{{ $data['email'] }}"> {{-- <-- TAMBAHKAN BARIS INI --}}
        ...
        {{-- Feedback --}}
        <div>
            <label for="feedback" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Kritik dan
                Saran</label>
            <textarea id="feedback" rows="8" name="feedback"
